...
describe("Liquidation", function () {
  let des = "8,128.956343 usdc";

  it(des, async function () {
    ...
    const LiquidationOperator = await ethers.getContractFactory("problem3");
    ...
    console.log("------------------------");
    console.log("Total Profit = ", utils.formatEther(profit), "ETH");
    console.log("------------------------");
